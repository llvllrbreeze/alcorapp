...
int matrix33_isnan(matrix33_t a)
{
  int nan;
  nan = 0;
  nan = nan | _isnan(a.m[0][0]);
  nan = nan | _isnan(a.m[0][1]);
  nan = nan | _isnan(a.m[0][2]);
  nan = nan | _isnan(a.m[1][0]);
  nan = nan | _isnan(a.m[1][1]);
  nan = nan | _isnan(a.m[1][2]);
  nan = nan | _isnan(a.m[2][0]);
  nan = nan | _isnan(a.m[2][1]);
  nan = nan | _isnan(a.m[2][2]);
  return nan;
}
...
int matrix44_isnan(matrix44_t a)
{
  ...
  nan = nan | _isnan(a.m[0][1]);
  nan = nan | _isnan(a.m[0][2]);
  nan = nan | _isnan(a.m[0][3]);
  nan = nan | _isnan(a.m[1][0]);
  nan = nan | _isnan(a.m[1][1]);
  nan = nan | _isnan(a.m[1][2]);
  nan = nan | _isnan(a.m[1][3]);
  nan = nan | _isnan(a.m[2][0]);
  nan = nan | _isnan(a.m[2][1]);
  nan = nan | _isnan(a.m[2][2]);
  nan = nan | _isnan(a.m[2][3]);
  nan = nan | _isnan(a.m[3][0]);
  nan = nan | _isnan(a.m[3][1]);
  nan = nan | _isnan(a.m[3][2]);
  nan = nan | _isnan(a.m[3][3]);
  return nan;
}
